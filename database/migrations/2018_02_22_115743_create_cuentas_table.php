...
class CreateCuentasTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Cuentas", 'cuentas', 'folio', 'fa-money', [
            ["franquicia_id", "Franquicia", "Dropdown", false, "", 0, 0, false, "@sucursals"],
            ["folio", "Folio", "TextField", false, "", 0, 256, false],
            ["monto", "Monto", "Currency", false, "", 0, 11, false],
            ["tipofactura", "Tipo de Factura", "Dropdown", false, "", 0, 0, false, ["Regalias","Producto","Servicio Admnistrativo"]],
            ["pdf", "PDF", "File", false, "", 0, 0, false],
            ["xml", "XML", "File", false, "", 0, 0, false],
            ["fecha", "Fecha", "Date", false, "", 0, 0, false],
            ["concepto", "Concepto", "Textarea", false, "", 0, 0, false],
        ]);
