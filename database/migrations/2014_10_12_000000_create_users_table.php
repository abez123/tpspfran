...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Users", 'users', 'name', 'fa-group', [
            ...
            ["context_id", "Context", "Integer", false, "0", 0, 11, false],
            ["email", "Email", "Email", true, "", 0, 250, false],
            ["password", "Contraseña", "Password", false, "", 6, 250, true],
            ["type", "Tipo de Usuario", "Dropdown", false, "Employee", 0, 0, false, ["Employee","Client"]],
        ]);
