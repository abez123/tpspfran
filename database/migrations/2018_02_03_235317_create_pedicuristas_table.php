...
class CreatePedicuristasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Pedicuristas", 'pedicuristas', 'nombrecompletoped', 'fa-user-plus', [
            ...
            ["pediespecial", "Pedicure Especial", "Checkbox", false, "", 0, 0, false],
            ["manicure", "Manicure", "Checkbox", false, "", 0, 0, false],
            ["masaje", "Masaje", "Checkbox", false, "", 0, 0, false],
            ["gelish", "Gelish", "Checkbox", false, "", 0, 0, false],
            ["horario_entrada", "Horario de Entrada", "Datetime", false, "", 0, 0, false],
            ["horario_salida", "Horario de Salida", "Datetime", false, "", 0, 0, false],
    ...
    {
        if (Schema::hasTable('pedicuristas')) {
            Schema::drop('pedicuristas');
        }
    }
}
