...
class CreateEnlacesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Enlaces", 'enlaces', 'nombrenenlace', 'fa-link', [
            ["nombrenenlace", "Nombre", "Name", true, "", 0, 256, false],
            ["enlace", "Enlace", "URL", false, "", 0, 256, false],
