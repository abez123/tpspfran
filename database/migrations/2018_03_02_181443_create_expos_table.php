...
class CreateExposTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Expos", 'expos', 'nombreexpo', 'fa-magnet', [
            ["nombreexpo", "Nombre ", "Name", false, "", 0, 256, false],
            ["empleados", "¿Quienes atenderán?", "Multiselect", false, "", 0, 0, false, "@employees"],
        ]);
