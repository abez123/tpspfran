...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $cuenta->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Cuentas", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/cuentas/'.$cuenta->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Cuentas", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.cuentas.destroy', $cuenta->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/cuentas') }}" data-toggle="tooltip" data-placement="right" title="Back to Cuentas"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'franquicia_id')
						@la_display($module, 'folio')
						@la_display($module, 'monto')
						@la_display($module, 'tipofactura')
						@la_display($module, 'pdf')
						@la_display($module, 'xml')
						@la_display($module, 'fecha')
						@la_display($module, 'concepto')
					</div>
				</div>
			</div>
		</div>
