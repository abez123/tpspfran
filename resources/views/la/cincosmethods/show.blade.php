...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $cincosmethod->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("CincosMethods", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/cincosmethods/'.$cincosmethod->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("CincosMethods", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.cincosmethods.destroy', $cincosmethod->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/cincosmethods') }}" data-toggle="tooltip" data-placement="right" title="Back to CincosMethods"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'unneed')
						@la_display($module, 'observacionsort1')
						@la_display($module, 'necesary')
						@la_display($module, 'observacionsort2')
						@la_display($module, 'uneedinventory')
						@la_display($module, 'observacionsort3')
						@la_display($module, 'clutter')
						@la_display($module, 'observacionsort4')
						@la_display($module, 'tagged')
						@la_display($module, 'observacionsort5')
					</div>
				</div>
			</div>
		</div>
