...
@section("contentheader_description", "Empresas lista")
@section("section", "Empresas")
@section("sub_section", "Lista")
@section("htmlheader_title", "Empresas Lista")

@section("headerElems")
@la_access("Empresas", "create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal"><i class="fa fa-plus"></i> Empresa</button>
@endla_access
@endsection
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"><i class="fa fa-plus"></i> Empresa</h4>
			</div>
