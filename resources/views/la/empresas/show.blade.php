...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $empresa->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Empresas", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/empresas/'.$empresa->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Empresas", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.empresas.destroy', $empresa->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/empresas') }}" data-toggle="tooltip" data-placement="right" title="Back to Empresas"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'nombreempresa')
						@la_display($module, 'direccion')
						@la_display($module, 'telefono')
						@la_display($module, 'cp')
						@la_display($module, 'correo')
						@la_display($module, 'empleado_id')
					</div>
				</div>
			</div>
		</div>
