...
@section("contentheader_title", "Peticions")
@section("contentheader_description", "Peticions lista")
@section("section", "Peticions")
@section("sub_section", "Lista")
@section("htmlheader_title", "Peticions Lista")
...
<div class="modal fade" id="AddModal" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			{!! Form::open(['action' => 'LA\PeticionsController@store', 'id' => 'peticion-add-form']) !!}
...
$(function () {
	$("#example1").DataTable({
		...
		processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/peticion_dt_ajax') }}",
		language: {
