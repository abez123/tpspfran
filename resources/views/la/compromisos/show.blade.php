...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $compromiso->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Compromisos", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/compromisos/'.$compromiso->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Compromisos", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.compromisos.destroy', $compromiso->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/compromisos') }}" data-toggle="tooltip" data-placement="right" title="Back to Compromisos"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'checklist_id')
						@la_display($module, 'comentariocompromiso')
						@la_display($module, 'fechacompromiso')
						@la_display($module, 'fechaentrega')
						@la_display($module, 'estatuscompromiso')
						@la_display($module, 'evidencia')
					</div>
				</div>
			</div>
		</div>
