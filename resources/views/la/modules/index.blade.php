...
@section("contentheader_description", "módulos lista")
@section("section", "Módulos")
@section("sub_section", "Lista")
@section("htmlheader_title", "Módulos Lista")

@section("headerElems")
<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal"><i class="fa fa-plus"></i> Módulo</button>
@endsection
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"><i class="fa fa-plus"></i> Módulo</h4>
			</div>
			...
			<div class="modal-body">
				<div class="box-body">
					<div class="form-group">
						...
						{{ Form::text("name", null, ['class'=>'form-control', 'placeholder'=>'Nombre dle Módulo', 'data-rule-minlength' => 2, 'data-rule-maxlength'=>20, 'required' => 'required']) }}
					</div>
					<div class="form-group">
