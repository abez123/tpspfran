...
<div id="page-content" class="profile2">
	...
	@endif
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					...
					<p class="desc">@if(isset($module->is_gen) && $module->is_gen) <div class="label2 success">Módulo Generado</div> @else <div class="label2 danger" style="border:solid 1px #FFF;">Módulo no Generado</div> @endif</p>
				</div>
			</div>
		</div>
		<div class="col-md-3">
		...
		<div class="col-md-4">
			@if($module->view_col != "")
				@if(isset($module->is_gen) && $module->is_gen)
					<div class="dats1 text-center"><a data-toggle="tooltip" data-placement="left" title="Update Module" class="btn btn-sm btn-success" style="border-color:#FFF;" id="generate_update" href="#"><i class="fa fa-refresh"></i> Actualizar Módulo</a></div>
					<div class="dats1 text-center"><a data-toggle="tooltip" data-placement="left" title="Update Migration File" class="btn btn-sm btn-success" style="border-color:#FFF;" id="update_migr" href="#"><i class="fa fa-database"></i> Actualizar Migración</a></div>
				@else
					<div class="dats1 text-center"><a data-toggle="tooltip" data-placement="left" title="Generate Migration + CRUD + Module" class="btn btn-sm btn-success" style="border-color:#FFF;" id="generate_migr_crud" href="#"><i class="fa fa-cube"></i> Generar Migración + CRUD</a></div>
					
 					<div class="dats1 text-center"><a data-toggle="tooltip" data-placement="left" title="Generate Migration File" class="btn btn-sm btn-success" style="border-color:#FFF;" id="generate_migr" href="#"><i class="fa fa-database"></i> Generar Migración</a></div>
				@endif
			@else
				<div class="dats1 text-center">Para generar la Migración o CRUD, establece la columna de vista usando el <i class='fa fa-eye'></i> icono a un lado de la columna</div>
			@endif
		</div>
	...
	<ul id="module-tabs" data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		...
		<li class="tab-pane" id="fields">
			<a id="tab_fields" role="tab" data-toggle="tab" class="tab_info" href="#fields" data-target="#tab-info"><i class="fa fa-bars"></i> Campos del Módule</a>
		</li>
		
		<li class="tab-pane" id="access">
			<a id="tab_access" role="tab" data-toggle="tab"  class="tab_info " href="#access" data-target="#tab-access"><i class="fa fa-key"></i> Accesos</a>
		</li>
		
		<li class="tab-pane" id="sort">
			<a id="tab_sort" role="tab" data-toggle="tab"  class="tab_info " href="#sort" data-target="#tab-sort"><i class="fa fa-sort"></i> Sortear</a>
		</li>
		
		<a data-toggle="modal" data-target="#AddFieldModal" class="btn btn-success btn-sm pull-right btn-add-field" style="margin-top:10px;margin-right:10px;"><i class="fa fa-plus"></i> Campo</a>
	</ul>
	...
	<div class="tab-content">
		...
		<div role="tabpanel" class="tab-pane fade in p20 bg-white" id="tab-access">
			<div class="guide1">
				<span class="pull-left">Acceso a Módulos por roles</span>
				<i class="fa fa-circle gray"></i> Invisible <i class="fa fa-circle orange"></i> Solo-Leer <i class="fa fa-circle green"></i> Escribir
			</div>
				...
				<table class="table table-bordered dataTable no-footer table-access">
					<thead>
						<tr class="blockHeader">
							...
							<th width="14%">
								<input class="alignTop" type="checkbox" id="delete_all" >&nbsp; Borrar
							</th>
							<th width="14%">Privilegios de Campo</th>
						</tr>
					</thead>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Borrar Módulo</h4>
			</div>
			<div class="modal-body">
				<p>¿Está seguro que quiere borrar éste módulo?<b id="moduleNameStr" class="text-danger"></b> ?</p>
				<p>Las siguientes archivos se borrarán:</p>
				<div id="moduleDeleteFiles"></div>
				<p class="text-danger">Nota: El archivo de Migración no se borrará pero si se modificará.</p>
			</div>
			<div class="modal-footer">
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.modules.destroy', 0], 'id' => 'module_del_form', 'method' => 'delete', 'style'=>'display:inline']) }}
					<button class="btn btn-danger btn-delete pull-left" type="submit">Si</button>
				{{ Form::close() }}
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"><i class="fa fa-plus"></i> Campo para {{ $module->model }} </h4>
			</div>
			...
			<div class="modal-body">
				<div class="box-body">
					<div class="form-group">
						...
						{{ Form::text("label", null, ['class'=>'form-control', 'placeholder'=>'Field Label', 'data-rule-minlength' => 2, 'data-rule-maxlength'=>256, 'required' => 'required']) }}
					</div>
					
					<div class="form-group">
						<label for="colname">Nombre de la Columna :</label>
					...
					<div class="form-group values">
						...
						<div class="radio" style="margin-bottom:20px;">
							<label>{{ Form::radio("popup_value_type", "table", true) }} De una Tabla</label>
							<label>{{ Form::radio("popup_value_type", "list", false) }} De una Lista</label>
						</div>
