...
@section("sub_section", "Editar Campo")

@section("htmlheader_title", "Editar Campo : ".$field->label)
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				{!! Form::model($field, ['route' => [config('laraadmin.adminRoute') . '.module_fields.update', $field->id ], 'method'=>'PUT', 'id' => 'field-edit-form']) !!}
					...
					<div class="form-group">
						<label for="field_type">Tipo de Columna:</label>
					...
					<div class="form-group values">
						...
						<div class="radio" style="margin-bottom:20px;">
							<label>{{ Form::radio("popup_value_type", "table", $popup_value_type_table) }} De una Tabla</label>
							<label>{{ Form::radio("popup_value_type", "list", $popup_value_type_list) }} De una Lista</label>
						</div>
                    ...
                    <br>
					<div class="form-group">
						{!! Form::submit( 'Actualizar', ['class'=>'btn btn-success']) !!} <button class="btn btn-default pull-right"><a href="{{ url(config('laraadmin.adminRoute') . '/modules/'.$module->id) }}">Cancelar</a></button>
					</div>
				{!! Form::close() !!}
