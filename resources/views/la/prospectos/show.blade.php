...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $prospecto->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Prospectos", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/prospectos/'.$prospecto->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Prospectos", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.prospectos.destroy', $prospecto->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/prospectos') }}" data-toggle="tooltip" data-placement="right" title="Back to Prospectos"><i class="fa fa-chevron-left"></i></a></li>
...
@la_display($module, 'expo')
						@la_display($module, 'nombrecompletoprosp')
						@la_display($module, 'telefono')
						@la_display($module, 'celular')
						@la_display($module, 'email')
						@la_display($module, 'estadocivil')
						@la_display($module, 'experiencia')
						@la_display($module, 'cualexperiancia')
						@la_display($module, 'sutrabajoactual')
						@la_display($module, 'negociopropio')
						@la_display($module, 'experianciafran')
						@la_display($module, 'cualexperianciafran')
						@la_display($module, 'queciudad')
						@la_display($module, 'localpropio')
						@la_display($module, 'uicacionmetros')
						@la_display($module, 'fechadeseo')
						@la_display($module, 'solventadapor')
						@la_display($module, 'especificarotro')
						@la_display($module, 'cargoquien')
						@la_display($module, 'inversion')
						@la_display($module, 'comentarios')
						@la_display($module, 'atendidopor')
						@la_display($module, 'fechaprimercontacto')
					</div>
				</div>
			</div>
		</div>
