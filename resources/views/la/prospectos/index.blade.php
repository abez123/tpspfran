...
@section("contentheader_title", "Prospectos")
@section("contentheader_description", "Prospectos lista")
@section("section", "Prospectos")
@section("sub_section", "Lista")
@section("htmlheader_title", "Prospectos Lista")

@section("headerElems")
@la_access("Prospectos", "create")
...
<div class="modal fade" id="AddModal" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			{!! Form::open(['action' => 'LA\ProspectosController@store', 'id' => 'prospecto-add-form']) !!}
...
$(function () {
	$("#example1").DataTable({
		...
		processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/prospecto_dt_ajax') }}",
		language: {
