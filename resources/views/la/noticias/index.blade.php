...
@section("contentheader_description", "Noticias lista")
@section("section", "Noticias")
@section("sub_section", "Lista")
@section("htmlheader_title", "Noticias Lista")

@section("headerElems")
@la_access("Noticias", "create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal"><i class="fa fa-plus"></i> Noticia</button>
@endla_access
@endsection
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"><i class="fa fa-plus"></i> Noticia</h4>
			</div>
