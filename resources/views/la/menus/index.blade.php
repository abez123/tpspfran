			...
			<div class="col-md-4 col-lg-4">
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs">
						...
						<li><a href="#tab-custom-link" data-toggle="tab">Enlaces personalizados</a></li>
					</ul>
					<div class="tab-content">
						...
						<div class="tab-pane" id="tab-custom-link">
							...
							{!! Form::open(['action' => '\Dwij\Laraadmin\Controllers\MenuController@store', 'id' => 'menu-custom-form']) !!}
								...
								<div class="form-group">
									<label for="name" style="font-weight:normal;">Etiqueta</label>
									<input class="form-control" placeholder="Etiqueta" name="name" type="text" value=""  data-rule-minlength="1" required>
								</div>
								<div class="form-group">
									<label for="icon" style="font-weight:normal;">Icono</label>
								...
								<input type="submit" class="btn btn-primary pull-right mr10" value="Agregar al Menu">
							{!! Form::close() !!}
						</div>
					</div><!-- /.tab-content -->
				</div><!-- nav-tabs-custom -->
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Editar Elemento del Menu</h4>
			</div>
